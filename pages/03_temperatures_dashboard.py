...
def load_data():
    ...
    temps_df = pd.read_csv(data_path ) # TODO: Ex 3.1: ,, index_col="show_id" index_col="show_id") Load the dataset using Pandas, use the data_path variable and set the index column to "show_id"
...
unique_countries_list = sorted(temps_df["City"].unique())
